...
2. **ADC Conversion:** The system uses the built-in Analog-to-Digital Converter to sample voltage and current channels sequentially, taking a 1000 measurements to smooth out the noise.
...
4. **Calibration Save:** Holding down the mode buttons pushes the current ADC reading as the new "Zero Reference" directly into the non-volatile EEPROM memory.
